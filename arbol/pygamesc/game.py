        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                if evento.key == pygame.K_a:
                    ...
                    guardar_csv() ## Para guardar los datos en csv con la 'q'
                    pygame.quit()
                    exit()
...
def reiniciar_juego():
    ...
    guardar_csv() ## Para guardar los datos en csv
...
def guardar_csv():
    if len(datos_modelo) == 0:
        ...
        return
    with open('datos_modelo.csv', 'w', newline='') as archivo:
        escritor = csv.writer(archivo)
        escritor.writerow(['Velocidad', 'Distancia', 'Salto'])  # Encabezados
...
def main():
    ...
    while correr:
        for evento in pygame.event.get():
            if evento.type == pygame.QUIT:
                correr = False
                guardar_csv() ## Para guardar los datos en csv al cerrar ventana
                correr = False
            if evento.type == pygame.KEYDOWN:
                ...
                if evento.key == pygame.K_q:  # Presiona 'q' para terminar el juego
                    print("Juego terminado. Datos recopilados:", datos_modelo)
                    guardar_csv() ## Para guardar los datos en csv al terminar con 'q'
                    pygame.quit()
                    exit()
    ...
    guardar_csv() ## Para guardar al salir del bucle
    pygame.quit()
